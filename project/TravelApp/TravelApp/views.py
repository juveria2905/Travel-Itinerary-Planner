...
def CancelBookingAction(request):
    if request.method == 'GET':
        pid = request.GET['pid']
        dbconnection = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = 'juveria', database = 'Travel',charset='utf8')
...
def CancelBookings(request):
    if request.method == 'GET':
        ...
        mysqlConnect = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = 'juveria', database = 'Travel',charset='utf8')
        with mysqlConnect:
